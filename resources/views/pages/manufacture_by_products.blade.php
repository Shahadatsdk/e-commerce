            ...
            <div class="product-image-wrapper">
                <div class="single-products">
                        <div class="productinfo text-center">
                            <img src="{{ URL::to($v_manufacture_by_product->product_image) }}" style="300px;" alt="" />
                            <h2>{{ $v_manufacture_by_product->product_price }}</h2>
                            <p>{{ $v_manufacture_by_product->product_name }}</p>
                            <a href="#" classv_manufacture_by_product="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                        </div>
