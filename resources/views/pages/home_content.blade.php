...
<div class="col-sm-12">
    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            $all_published_slider = DB::table('slider_tbl')->where('publication_status',1)
                                  ->get();
            ...
            <div class="item active">
                ...
                <?php } ?>
                    <div class="col-sm-12">
                        <img src="{{ URL::to($slider->slider_image) }}" class="girl img-responsive" style="margin-left: -20px;" ; alt="" /> 
            ...
            <div class="single-products">
                    ...
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <h2>${{ $product->product_price }}</h2>
                            <!-- <p>{{ $product->product_name }}</p> -->
                            <a href="{{ URL::to('/view_product/'.$product->product_id) }}" class="btn btn-default add-to-cart"><p style="color: red;">{{ $product->product_name }}</p></a>
                            <a href="{{ URL::to('/view_product/'.$product->product_id) }}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                        </div>
                    </div>
            </div>
